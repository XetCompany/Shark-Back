# Generated by Django 5.0.4 on 2024-04-07 22:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('new', 'Новый'), ('in_progress', 'В процессе'), ('awaiting', 'Ожидает забора'), ('delivered', 'Доставлен')], default='new', max_length=255, verbose_name='Статус')),
                ('decline_reason', models.TextField(blank=True, null=True, verbose_name='Причина отклонения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.grouppaths', verbose_name='Группа путей')),
        ...
        migrations.AddField(
            ...
            name='paths',
            field=models.ManyToManyField(through='app.PathGroup', to='app.path', verbose_name='Пути'),
        ),
        migrations.CreateModel(
            name='PointInCity',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.productcategory', verbose_name='Категория')),
